...
def CA_creation(df, degrees):
    """
    Performs Correspondence Analysis (CA) on species abundance, visualizes treatment group convex hulls, species projections, and statistical comparisons of species' DCi and network degree values.
    ...
    """
    # === Create abundance table (communities x species) ===
    y = [2017, 2018, 2021]
    ...
    percent_axis2 = ca.eigenvalues_[1] / sum(ca.eigenvalues_) * 100
    print(f"\nAxe 2 explains {percent_axis2:.2f}% of inertia")

    # === Define treatment groups and colors ===
    group_colors = {"G_CP": "#0072b299", "L_TP": "#e69f0099", "L_CP": "#f0e44299"}
    ...
    for sp in df_CA["Species"].unique():
        ...
        if degree_alpine != 0 and degree_warmed != 0:
            ...
            sp_colors[sp] = "#009e73ff"  # alpine only
        elif degree_warmed != 0:
            sp_colors[sp] = "#cc79a7ff"  # warmed only
    ...
    colors_box = ["#0072b299", "#e69f0099", "#f0e44299"]
